...
trait ValidatesWeeklyAvailability
{
    /**
     * @return array<string, mixed>
     */
    protected function weeklyAvailabilityRules(bool $required): array
    {
        $presence = $required ? ['required', 'array', 'min:1'] : ['nullable', 'array'];

        return [
            'weekly_availability' => $presence,
     ...
     */
    protected function weeklyAvailabilityMessages(): array
    {
        return [
            'weekly_availability.required' => 'Agregá al menos una franja semanal.',
            'weekly_availability.min' => 'Agregá al menos una franja semanal.',
    ...
    protected function validateWeeklyAvailabilityBands(Validator $validator): void
    {
