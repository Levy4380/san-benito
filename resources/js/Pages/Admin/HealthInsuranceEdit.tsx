...
export default function AdminHealthInsuranceEdit({ healthInsurance, doctors }: Props) {
    const form = useForm({
    ...
    return (
        <>
            <Head title={healthInsurance.name} />
            <PageScreen
                header={
                    <PageHeader
                    ...
                    <Results className="gap-[var(--space-md)]">
                        <form
                            ...
                            onSubmit={(event) => {
                                ...
                                form.patch(`/admin/settings/health-insurances/${healthInsurance.id}`);
                            }}
                        >
